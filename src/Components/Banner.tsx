    ...
    return (
        <div className="m-1.5 flex justify-between  container mx-auto items-center ">
            <div >
                ...
                <h1 className="text-[56px] font-bold leading-[1.05] tracking-[-2px] block bg-gradient-to-r from-[#FF5722] via-[#E91E63] to-[#7C3AED] bg-clip-text text-transparent">Development Stack</h1>
            ...
            <div>
                <img src={Baner} alt="Banner" className="w-[400px] mb-4" />
            </div>
